export const downloads = [
  {
    ...
    fileFull:
      '/files/v1.4.2/§2§lFurf§b§lSky §5§lReborn §8§lFL§8§l[§71.4.2§8§l].zip',
    fileOverlay:
      'files/v1.4.2/§2§lFurf§b§lSky §5§lReborn §8§lOV §8§l[§71.4.2§8§l].zip',
  },
  {
    version: 'v1.4.1',
    name: "Rosetta's Wares",
    fileFull:
      '/files/v1.4.1/§r§lFurfSky §6§lReborn §8§lFL §8§l[§71.4.1§8§l].zip',
    fileOverlay:
      '/files/v1.4.1/§r§lFurfSky §6§lReborn §8§lOV §8§l[§71.4.1§8§l].zip',
  },
  {
    version: 'v1.4',
    name: "Journey's Beginning<br><small>(Crystal Hollows items and more!)</small>",
    fileFull: '/files/v1.4/§r§lFurfSky §6§lReborn §8§lFL §8§l[§71.4§8§l].zip',
    fileOverlay:
  ...
  },
  {
    version: 'v1.69',
    name: 'April Fools!',
    fileFull: '/files/v1.69/§r§lFurfSky §6§lReborn §8§lFL §8§l[§71.69§8§l].zip',
    fileOverlay:
  ...
  },
  {
    ...
    fileOverlay: '/files/v0.2.0/§6Furf§5Sky §eReborn §8§lOV [§70.2.0.§8§l].zip',
  },
  {
