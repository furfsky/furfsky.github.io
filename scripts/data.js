...
const data = {
  header: {
    ...
    subtitle: [
      ...
      `${String(Math.floor((((new Date(date.getTime())) - (new Date('October 30, 2020 00:00:00'))) / 1000) / 86400))} days since Perfect Armor hasn't had a texture`,
      `<h2>big text</h2>`,
      ...
      `Welcome to https://furfsky.github.io, the only place where you won't be murdered for using the &lt;i&gt; HTML tag instead of &lt;span style="font-style: italic;"&gt;.`,
      `There are currently quotes (including this one) on this site. Reload to see if your submission was one of them!`,
      ...
      `the number 8 is my favorite color of the furfsky reborn resource pack<br><br><small>(quote inspired by certain misadventures in video recording from a certain mod developer who streams often on twitch)</small>`,
